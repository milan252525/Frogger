...
Hrou, kterou jsem se rozhodl napodobit, je Frogger z roku 1992 [1]. Inspirací mi byla ještě jiná stejnojmenná verze hry z roku 1981 [2] a to hlavně její lepším grafickým zpracování. Hra je vytvořená v jazyce C# pomocí grafické knihovny Windows Forms. 
...
Prostředí je tvořené z dílku, každý má velikost 64x64 bodů, právě kvůli velikosti obrázků. Nejdřív je nakresleno pozadí, podle přednastavených pravidel. Na pozadí jsou potom přikreslovány herní objetky. Prostředí obsahuje 9 dílků na šířku a 11 na výšku.
...
V případě náhodné úrovně jsou jednotlivé řetězce vygenerovány náhodně, četnost vytváření objektů a délka klád je potom generována z předem vybraných intervalů, aby byla úrověň hratelná.
...
| Náhodná          |            | Prostředí je vygenerováno naprosto náhodně. Tudíž obtížnost je vždy různá. |
...
Dále se zkontroluje zda nějaké auto není na stejném políčku jako žába, zda žába není na vodě bez klády, za kláda nepohla žábu mimo obrazovku nebo jestli už žába nedoskákala na leknín. Ve všech případech se změní stav hry. 
